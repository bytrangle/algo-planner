...
async function parseStudyInfo(messages: ChatMessage[]): Promise<ParserOutput> {
  ...
  try {
    ...
    return {
      ...
      hoursPerDay: typeof parsed.hoursPerDay === "number" ? parsed.hoursPerDay : null,
...
export async function POST(request: NextRequest) {
  ...
  const assistantContent = result.question ?? "Study plan information collected.";
